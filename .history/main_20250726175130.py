...
TILE_MAP_SIZE = 20
tile_map = [[random.randint(0, 2) for _ in range(TILE_MAP_SIZE)] for _ in range(TILE_MAP_SIZE)]  # 20x12 tiles
TILE_SIZE = 64
tile_colors = {0: (34, 139, 34), 1: (139, 69, 19),2: (0, 255, 255) }   # upgrade station (cyan)}
